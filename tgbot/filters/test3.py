...
async def main():
    text ="https://docs.aiogram.dev/en/stable/utils/keyboard.html#aiogram.utils.keyboard.InlineKeyboardBuilder.adjust salom"
    result = await get_links_from_text(text)
    print(result)
